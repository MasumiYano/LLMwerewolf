...
def generate(state: MessagesState):
    ...
    system_message_content = (
        ...
        "don't know. Use three senteces maximum and keep the "
        "answer concise."
        "\n\n"
        f"{docs_content}"
    )
...
input_message_2 = "What is Task Decomposition?"

for step in graph_2.stream(
...
input_message_3 = "Can you look up some common ways of doing it?"
